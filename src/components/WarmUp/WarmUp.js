                ...
                <Row>
                    <Col span={12} align="start" className={cssClasses.chatHint}>
                        ...
                        <Row justify="left" style={{ marginTop: "20px" }}>
                            <Input style={{ width: '40%', marginRight: "10px", minWidth: "300px" }} placeholder="Input flag here" onChange={this.onChangeInput} />
                    ...
                    <Col span={12}>
                        <Row justify="center">
                            <a className={cssClasses.TryItOut} href="/robots.txt" target="new">
                                <img style={{ width: '250px' }} src={tryIcon} href="/robots.txt" target="new" />
                            </a>
                        </Row>

                        <Row align="center" style={{ marginTop: "20px" }}>
                            {this.state.success ? (<Alert message="Congratulation" type="success" />) : null}
                            {!this.state.hiddenFalse ? (<Alert message="Try Again" type="error" />) : null}
                        </Row>
                    </Col>
